...
// $refrensi = $_GET['refrensi'];                     
  ...
  $nameSql = mysqli_query($db, "SELECT refrensi, posisi_rekomendasi, komentar, pengalaman_kerja, nama_lengkap, posisi, post_date FROM recruitment WHERE post_date BETWEEN '$start_date' AND '$end_date' AND (status_pelamar = 'DISARANKAN' OR status_pelamar = 'REJECTED') Group BY post_date, posisi");
