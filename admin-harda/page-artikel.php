          ...
          <div class="box pad10">
            ...
            <div class="box-body table-responsive no-padding">
              <a class="btn-export-excel" href="javascript:void(0);" target="_BLANK">
                <button class="btn btn-warning btn-submit" data-toggle="modal" data-target="#modalArtikel">Tambah Artikel<i class="fa fa-archive"></i></button>
              </a>
               <!-- <a class="btn-export-excel" href="javascript:void(0);" target="_BLANK">
              ...
              <tbody>
                ...
                <tr>
                  <td><?= $no; ?></td>
                  <td><?= $judul_artikel ?></td>
                  <td><img class="img-home" src="<?= $foto_artikel; ?>"></td>
                  <td><?= $newDate; ?></td>
                  <td>

                    <?php echo "<a href='#modalHomeEdit' id='custId' data-toggle='modal' data-id=".$row['idartikel']."><span class='action-icon'><i class='fa fa-cogs'></i></span></a>" ?>
                    
                    <a href='server.php?idartikel=<?php echo $row['idartikel']; ?>' onclick="return confirm('Apakah yakin album ini akan dihapus?')"><span class='action-icon'><i class='fa fa-trash'></i></span></a>
